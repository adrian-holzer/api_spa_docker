...
public class RespuestaService {
    ...
    public Respuesta crearYEnviarRespuesta(Respuesta respuesta, String emailDestinatario) {
        ...
        if (!userDetails.getAuthorities().stream().anyMatch(a -> a.getAuthority().equals("PROFESIONAL"))) {
        ...
        try {
            this.emailService.enviarRespuestaPorEmail(emailDestinatario, asunto, cuerpo);
